...
@section('title', 'AccountMin - Journal Penyesuaian')
      ...
      <div class="row align-items-end">
        <div class="col-lg-8">
          <div class="page-header-title">
            ...
            <div class="d-inline">
              <h5>Create Journal Penyesuaian</h5>
        ...
        <div class="col-lg-4">
          <nav class="breadcrumb-container" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Journal Penyesuaian</li>
    ...
    <div class="row" id="app">
      <div class="col-md-12">
        @if (count($errors) > 0)
          ...
          @endif
        <form class="forms-sample" id="a" action="{{route('jp.store')}}" method="post">
          @csrf
          <div class="card">
            <div class="card-header" style="background: #2dce89;"><h3 style="color: white">Journal Penyesuaian</h3>
            </div>
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    @endphp
                    <input class="form-control" type="text" name="kode" id="no_transaksi" value="JP-{{$hasil}}" readonly>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
