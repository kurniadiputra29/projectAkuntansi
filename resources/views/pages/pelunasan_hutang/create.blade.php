...
@section('title', 'AccountMin - Create Pelunasan Hutang')
          ...
          <nav class="breadcrumb-container" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">
                <a href="/pelunasan_hutang">Pelunasan Hutang</a>
              </li>
    ...
    <div class="row" id="app">
      <div class="col-md-12">
        @if (count($errors) > 0)
          ...
          @endif
    <form class="forms-sample" id="b" action="{{route('pelunasan_hutang.store')}}" method="post">
          @csrf
          <div class="card">
            <div class="card-header" style="background: #fb6340;"><h3 style="color: white">Pelunasan Hutang</h3>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    @endphp
                    <input class="form-control" type="text" name="kode" id="no_transaksi" value="PH-{{$hasil}}" readonly>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
          ...
          <div class="forms-sample" style="margin-bottom: 10px; margin-top: 10px; justify-content: space-between; display: flex;">
            <a href="{{route('pelunasan_hutang.index')}}" class="btn btn-secondary btn-rounded"><i class="ik ik-arrow-left"></i>Back</a>
