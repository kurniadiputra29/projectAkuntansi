...
@section('title',  'AccountMin - Pelunasan Hutang')
          ...
          <div class="col-lg-4">
            <nav class="breadcrumb-container" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pelunasan Hutang</li>
              </ol>
            </nav>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-header d-flex justify-content-between flex-row">
              ...
              <div class="right-container">
                <a class="btn btn-outline-primary btn-rounded" href="{{ route('pelunasan_hutang.create') }}">Create</a>
              </div>
            </div>
            <div class="card-body">
              @if (count($errors) > 0)
                          ...
                          <td class="text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="aksiDropdown">
                                    <a href="{{route('pelunasan_hutang.edit', $key->id)}}" class="dropdown-item"><i class="ik ik-edit-2"> </i>Edit</a>
                                    <form method="get" action="{{ route('pelunasan_hutang.show', $key->id) }}">
                                      @csrf
                                      @method('GET')
                                      <button class="dropdown-item" type="submit"><i class="ik ik-eye"></i> Journal</button>
                                    </form>
                                    <form method="post" action="{{ route('pelunasan_hutang.destroy', $key->id) }}">
                                      @csrf
                                      @method('DELETE')
