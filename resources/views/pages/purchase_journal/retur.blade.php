...
@section('title', 'AccountMin - Create Retur Pembelian')
    ...
    <div class="row" id="app">
      <div class="col-md-12">
        @if (count($errors) > 0)
          ...
          @endif
        <form class="forms-sample" action="{{route('retur_pembelian.store')}}" method="post">
          @csrf
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <input class="form-control" name="purchasejournal_id" type="hidden" value="{{$cashbanks->id}}">
                <div class="col-md-4">
                  <div class="form-group">
