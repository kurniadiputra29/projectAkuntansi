    ...
    <div class="row" id="app">
      <div class="col-md-12">
        @if (count($errors) > 0)
          ...
          @endif
        <form class="forms-sample" action="{{route('purchase_journal.store')}}" method="post">
          @csrf
          <div class="card">
            <div class="card-header" style="background: #2dce89;"><h3 style="color: white">Purchase Journal</h3>
            </div>
            <div class="card-body">
              <div
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    @endphp
                    <input class="form-control" type="text" name="kode" id="no_transaksi" value="PJ-{{$hasil}}" readonly>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
...
<script type="text/javascript">
  new Vue({
   ...
   data: {
    cashbanks2: [
    {id_akun2:"{{$pemetaan_akuns->hutang}}"},
    ],
    cashbanks: [
