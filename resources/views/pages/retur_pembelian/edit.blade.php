        ...
        <form class="forms-sample" action="{{route('retur_pembelian.update', $cashbanks->id)}}" method="post">
          ...
          <div class="form-group row justify-content-end">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" name="nomor_akun_sales[]" value="{{$pemetaan_akuns->inventories->nomor}}">
              <input type="text" name="nama_akun2_sales[]" value="{{$pemetaan_akuns->inventories->nama}}">
            </div>
          </div>
          <div class="form-group row justify-content-end" >
            ...
            <div class="col-sm-4">
              <div class="checkbox-color checkbox-primary">
                  ...
                  <input type="text" name="nomor_akun_ppn[]" value="{{$pemetaan_akuns->ppn_pembelians->nomor}}">
                  <input type="text" name="nama_akun2_ppn[]" value="{{$pemetaan_akuns->ppn_pembelians->nama}}">
          ...
          <div class="form-group row justify-content-end">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" name="nomor_akun_jasa[]" value="{{$pemetaan_akuns->pengiriman_pembelians->nomor}}">
              <input type="text" name="nama_akun2_jasa[]" value="{{$pemetaan_akuns->pengiriman_pembelians->nama}}">
            </div>
          </div>
          ...
          <div class="form-group row justify-content-end">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" name="nomor_akun_diskon[]" value="{{$pemetaan_akuns->diskon_pembelians->nomor}}">
              <input type="text" name="nama_akun2_diskon[]" value="{{$pemetaan_akuns->diskon_pembelians->nama}}">
            </div>
          </div>
          <div class="form-group row justify-content-end">
  ...
  computed: {
    ...
    items() {
      ...
      @foreach($items as $key)
        @if($inventories->where('items_id',$key->id)->where('retur_pembelian_id', $cashbanks->id)->sum('total') < $Item_count)
