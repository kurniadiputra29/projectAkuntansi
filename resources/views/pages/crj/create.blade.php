...
@section('title', 'AccountMin - Create CRJ')
      ...
      <div class="row align-items-end">
        <div class="col-lg-8">
          <div class="page-header-title">
            ...
            <div class="d-inline">
              <h5>Create Cash Receipt Journal</h5>
        ...
        <div class="col-lg-4">
          <nav class="breadcrumb-container" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">CRJ</li>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    @endphp
                    <input class="form-control" type="text" name="kode" id="no_transaksi" value="CRJ-{{$hasil}}" readonly>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
...
<script type="text/javascript">
  new Vue({
   ...
   data: {
    ...
    cashbanks: [
    {id_item:"", harga:0, harga_jual:0, description:"", unit:1, jumlah: 0, sales:0},
    ],
    jasa_pengiriman: 0,
    diskon: 0,
    ppn: [],
  ...
  methods: {
    add() {
       var cashbanks = {id_item:"", harga:0, harga_jual:0, description:"", unit:1, jumlah: 0, sales:0};
