...
@section('title', 'AccountMin - Edit CRJ')
      ...
      <div class="row align-items-end">
        <div class="col-lg-8">
          <div class="page-header-title">
            ...
            <div class="d-inline">
              <h5>Edit Cash Receipt Journal</h5>
...
<script type="text/javascript">
  ...
  methods: {
    add() {
       var cashbank = {id_item:0, harga:0, harga_jual:0, description:"", unit:1, jumlah: 0, sales: 0};
  ...
  computed: {
    ...
    harga_juals() {
      ...
      @foreach($items as $key)
        ...
        @else
        harga_juals[ {{ $key->id }} ] = '{{$inventories->where('items_id', $key->id)->where('crj_id', $cashbanks->id)->sum('sales')}}'
        @endif
      @endforeach
      return harga_juals;
    },
