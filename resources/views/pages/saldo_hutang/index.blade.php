                  ...
                  <table id="simpletable" class="table table-striped table-bordered nowrap">
                    ...
                    <tfoot>
                      <tr class="bg-success font-weight-bold">
                        ...
                        <td class="text-right text-light">{{number_format($dataSaldoHutang->sum('debet'), 0, " ", ".")}}</td>
                        <td class="text-right text-light">{{number_format($dataSaldoHutang->sum('kredit'), 0, " ", ".")}}</td>
                        <td></td>
                      </tr>
                    </tfoot>
                  </table>
