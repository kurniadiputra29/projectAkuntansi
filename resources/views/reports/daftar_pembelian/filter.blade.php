          ...
          <div class="card">
            <div class="card-header d-flex justify-content-between flex-row">
              ...
              <div class="right-container d-flex flex-row">
                <a type="button" class="btn btn-success mr-5" href="/daftar_pembelian"><i class="ik ik-arrow-left"></i>Back</a>
                <form class="" action="{{route('daftar_pembelian.printF')}}" method="post">
                  @csrf
