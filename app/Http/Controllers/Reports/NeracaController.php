...
class NeracaController extends Controller
{
    ...
    public function print()
    {
        ...
        $pdf = PDF::loadview('reports.neraca.print', compact('asset','liability','equity','sum_debet_asset','sum_kredit_asset','sum_debet_liability','sum_kredit_liability','sum_debet_equity','sum_kredit_equity', 'accounts', 'distinct_laporan_penyesuaian', 'assets', 'liabilities', 'equities'));
