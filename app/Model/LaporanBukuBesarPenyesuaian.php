...
class LaporanBukuBesarPenyesuaian extends Model
{
    protected $table = 'laporan_buku_besar_penyesuaians';
    protected $fillable = ['account_id', 'saldo_awals_id', 'cpj_id', 'crj_id', 'purchasejournal_id', 'salesjournal_id', 'retur_penjualan_id', 'retur_pembelian_id','cash_bank_ins_id', 'cash_bank_outs_id' ,'jurnal_umums_id', 'pettycash_id', 'jurnalpenyesuaians_id', 'debet', 'kredit'];
